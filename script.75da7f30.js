...
},{}],"../node_modules/jsbarcode/bin/barcodes/Barcode.js":[function(require,module,exports) {
"use strict";
...
function renderItem(skuInput, upcInput) {
  var markup = "\n    <div class=\"bcContainer\" id=\"bcContainer-".concat(upcInput, "\">\n        <p id=\"sku\">Sku: ").concat(skuInput, "</p>\n        <svg id=\"barcode-").concat(upcInput, "\"></svg>\n    </div>\n    ");
  body.insertAdjacentHTML('beforeend', markup);
  (0, _jsbarcode.default)("#barcode-".concat(upcInput), "".concat(upcInput), {
    format: 'UPC',
    height: 60,
    width: 1.6
  });
...
function saveImage(node, arrEl) {
  _domToImage.default.toJpeg(document.getElementById("bcContainer-".concat(arrEl[1])), {
    quality: 0.95
  }).then(function (dataUrl) {
    var link = document.createElement('a');
    link.download = "".concat(arrEl[0], "-").concat(arrEl[1], ".jpeg");
    link.href = dataUrl;
    link.click();
  });
}
...
function saveImageArr(arr) {
  arr.forEach(function (el) {
    var node = document.getElementById("bcContainer-".concat(el[1]));
...
var upcField = document.getElementById('upc-field');
var upcLengthError = document.querySelector('.length-validate');
var upcCodeError = document.querySelector('.code-validate');
var generateBtn = document.getElementById('generate');
generateBtn.addEventListener('click', function () {
  console.log('clicked');
  var skuFieldVal = skuField.value;
  var upcFieldVal = upcField.value; //check upc

  if (upcFieldVal.length !== 12) {
    console.log(upcField.length);
    upcLengthError.classList.add('show');
    return;
  }

  var codeArr = [[skuFieldVal, Number(upcFieldVal)]];
  console.log(codeArr);

  try {
    mainFunc(codeArr);
  } catch (e) {
    upcCodeError.classList.add('show');
    return;
  }
...
},{"dom-to-image":"../node_modules/dom-to-image/src/dom-to-image.js","jsbarcode":"../node_modules/jsbarcode/bin/JsBarcode.js"}],"../../../../.npm-global/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
